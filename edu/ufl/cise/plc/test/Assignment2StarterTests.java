...
class Assignment2StarterTests {
	...
	@DisplayName("recursive unary")
	@Test
	public void recursiveUnary(TestInfo testInfo) throws Exception {
		String input = """
				-!-30
				""";
		show("-------------");
	...
	@DisplayName("COLOR_OP unary")
	@Test
	public void testColorop(TestInfo testInfo) throws Exception {
		String input = """
				getWidth-!-30
				""";
		show("-------------");
		...
		show(ast);
		assertThat("", ast, instanceOf(UnaryExpr.class));
		assertEquals(IMAGE_OP, ((UnaryExpr) ast).getOp().getKind());
		Expr var1 = ((UnaryExpr) ast).getExpr();
		assertThat("", var1, instanceOf(UnaryExpr.class));
	}

	@DisplayName("ConditionalExpr")
	@Test
	public void testConditional(TestInfo testInfo) throws Exception {
		String input = """
				a & b
				""";
		show("-------------");
	...
	@DisplayName("recursiveIf")
	@Test
	public void recursiveIf(TestInfo testInfo) throws Exception {
		String input = """
				if (a & b) if (x) if (y) i else j fi else z fi else c fi
				""";
		show("-------------");
		show(input);
		Expr ast = (Expr) getAST(input);
	...
	@Test
	public void leftAsscociativity(TestInfo testInfo) throws Exception {
		String input = """
				a + b + c
				""";
		show("-------------");
